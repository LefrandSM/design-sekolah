        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownProfile">
                    <a class="dropdown-item" href="#">Tentang Sekolah</a>
                    <a class="dropdown-item" href="#">Kepala Sekolah</a>
                    <a class="dropdown-item" href="#">Sejarah Sekolah</a>
                    <a class="dropdown-item" href="#">Visi, Misi dan Filosofi Pendidikan</a>
                    ...
                    <a class="dropdown-item" href="#">Lambang dan Lagu Kebangsaan Sekolah</a>
                </div>
            </li>
            <li class="nav-item dropdown">
